 ...
 */
public abstract class SpacetimeError
private constructor(message: String, cause: Throwable? = null) : Exception(message, cause) {

    /** The connection is already disconnected or has terminated normally. */
    public data object Disconnected :
        SpacetimeError("Connection is already disconnected or has terminated normally")
    ...
    public data object AlreadyUnsubscribed :
        SpacetimeError("Unsubscribe already called on subscription")
