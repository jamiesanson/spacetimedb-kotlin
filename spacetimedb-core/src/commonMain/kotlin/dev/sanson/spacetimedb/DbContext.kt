 ...
 *
 * Generated per-module `DbConnection` classes implement this interface with
 * concrete [Tables] and [Reducers] types, providing typed access to the
 * module's tables and reducers.
 *
