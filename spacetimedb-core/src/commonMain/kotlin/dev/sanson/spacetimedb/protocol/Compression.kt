 ...
 *
 * The client specifies its preferred compression via a query parameter when connecting. The server
 * then compresses responses accordingly.
 *
...
private constructor(internal val tag: Byte, internal val queryParam: String) {
    ...
    internal companion object {
        fun fromTag(tag: Byte): Compression =
            when (tag.toInt()) {
                0 -> None
                1 -> Brotli
                2 -> Gzip
